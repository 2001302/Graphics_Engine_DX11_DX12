...
void ShaderUtil::CreateVertexShader(
...
void ShaderUtil::CreatePixelShader(ComPtr<ID3D12Device> device,
...
void ShaderUtil::CreateComputeShader(ComPtr<ID3D12Device> device,
                                     std::wstring filename,
                                     ComPtr<ID3DBlob> &shader) {
    UINT compileFlags = 0;
#if defined(DEBUG) || defined(_DEBUG)
