...
struct CD3DX12_RECT : public D3D12_RECT {
    ...
    explicit CD3DX12_RECT(LONG Left, LONG Top, LONG Right,
...
struct CD3DX12_BOX : public D3D12_BOX {
    ...
    explicit CD3DX12_BOX(LONG Left, LONG Top, LONG Right,
                         LONG Bottom) noexcept {
        left = static_cast<UINT>(Left);
...
struct CD3DX12_CLEAR_VALUE : public D3D12_CLEAR_VALUE {
    ...
    CD3DX12_CLEAR_VALUE(DXGI_FORMAT format, FLOAT depth,
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER {
    ...
    static inline void
    InitAsConstants(_Out_ D3D12_ROOT_PARAMETER &rootParam, UINT num32BitValues,
...
struct CD3DX12_ROOT_PARAMETER1 : public D3D12_ROOT_PARAMETER1 {
    ...
    static inline void
    InitAsConstants(_Out_ D3D12_ROOT_PARAMETER1 &rootParam, UINT num32BitValues,
                    UINT shaderRegister, UINT registerSpace = 0,
                    D3D12_SHADER_VISIBILITY visibility =
                        D3D12_SHADER_VISIBILITY_ALL) noexcept {
        rootParam.ParameterType = D3D12_ROOT_PARAMETER_TYPE_32BIT_CONSTANTS;
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE {
    ...
    Offset(INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept {
  ...
  private:
    ...
    class SUBOBJECT_HELPER_BASE {
      public:
        ...
        void
        AddToStateObject(CD3DX12_STATE_OBJECT_DESC &ContainingStateObject) {
